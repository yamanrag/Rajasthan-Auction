...
import img from "../assets/Auction-Home1.jpg"
import img2 from "../assets/online-Auction.jpg"
  ...
  return (
    ...
    <div>
      ...
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
          ...
          <span className="ml-3 text-xl">Rajasthan Auction</span>
        </a>
    ...
    <section className="text-gray-700 body-font">
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Bid Smart, Win Big:
    
            <br className="hidden lg:inline-block"/>Your Gateway to
            Online Auctions
          </h1>
          <p className="mb-8 leading-relaxed">Discover a new era of online auctions with our cutting-edge platform designed to bring buyers and sellers together in a seamless, secure, and engaging environment. Whether you are looking to find great deals or sell unique items, our system provides real-time bidding, transparent transactions, and a wide array of categories to explore. Join our community today and experience the excitement of winning big in the world of online auctions!</p>
          <div className="flex justify-center">
            <button className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" onClick={() => navigate("/signup")}>Signup</button>
            <button className="ml-4 inline-flex text-gray-700 bg-gray-200 border-0 py-2 px-6 focus:outline-none hover:bg-gray-300 rounded text-lg" onClick={() => navigate("/login")}>Login</button>
          </div>
        </div>
      ...
      <div className="container px-5 py-24 mx-auto flex flex-wrap">
        ...
        <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
          <div className="flex flex-col mb-10 lg:items-start items-center">
            ...
            <div className="flex-grow">
              <h2 className="text-gray-900 text-lg title-font font-medium mb-3">Unique Treasures</h2>
              <p className="leading-relaxed text-base">Explore a world of traditional Rajasthan artifacts, antiques, and hand-crafted art. Every auction brings unique treasures from the heart of Rajasthan’s cultural heritage, available to the highest bidder. Join us and own a piece of history.</p>
              <a className="mt-3 text-indigo-500 inline-flex items-center">Learn More
                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                  <path d="M5 12h14M12 5l7 7-7 7"></path>
                </svg>
          ...
          <div className="flex flex-col mb-10 lg:items-start items-center">
            ...
            <div className="flex-grow">
              <h2 className="text-gray-900 text-lg title-font font-medium mb-3">The Royal Auction</h2>
              <p className="leading-relaxed text-base">Engage in live auctions featuring exclusive items like royal jewelry, historical manuscripts, and rare collectibles. Experience the excitement of bidding in real-time with an intuitive platform designed for seamless participation.</p>
              <a className="mt-3 text-indigo-500 inline-flex items-center">Learn More
                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                  <path d="M5 12h14M12 5l7 7-7 7"></path>
                </svg>
          ...
          <div className="flex flex-col mb-10 lg:items-start items-center">
            ...
            <div className="flex-grow">
              <h2 className="text-gray-900 text-lg title-font font-medium mb-3">Secure Transactions</h2>
              <p className="leading-relaxed text-base">Bid confidently with our secure payment gateway, ensuring that your transactions are smooth and safeguarded. Our escrow service guarantees that sellers and buyers are protected, offering a fair and transparent marketplace.</p>
              <a className="mt-3 text-indigo-500 inline-flex items-center">Learn More
                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                  <path d="M5 12h14M12 5l7 7-7 7"></path>
                </svg>
    ...
    <section className="text-gray-700 body-font border-t border-gray-200">
      <div className="container px-5 py-24 mx-auto">
        <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
          ...
          <p className="leading-relaxed text-lg">Welcome to the ultimate auction playground, where innovation meets the thrill of discovery! Our platform is a dynamic fusion of retro charm and modern sophistication, designed to bring a kaleidoscope of possibilities right to your fingertips. From quirky collectibles to timeless treasures, every item tells a story and every bid sparks a new adventure. Dive into a seamless, secure, and electrifying experience featuring real-time bidding wars, transparent transactions, and a treasure trove of categories that cater to every taste. Whether you’re a savvy seller or a bold bidder, join our vibrant community today and turn every auction into a chance to win big!</p>
          <span className="inline-block h-1 w-10 rounded bg-indigo-500 mt-8 mb-6"></span>
          <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">Made by </h2>
          <p className="text-gray-500"> Yaman Prakash  </p>
        </div>
      </div>
    </section>
    <section className="text-gray-700 body-font relative">
      <div className="absolute inset-0 bg-gray-300 blur-md">
        ...
        <img src={img} alt="map" className="w-full h-full object-cover object-center absolute inset-0"/>
      </div>
      <div className="container px-5 py-24 mx-auto flex">
        <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10">
          <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Feedback</h2>
          <p className="leading-relaxed mb-5 text-gray-600">Your feedback matters! We value your suggestions and insights.</p>
    ...
    <footer className="text-gray-700 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap text-center -mb-10 -mx-4">
          ...
          <div className="lg:w-1/3 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a className="text-gray-600 hover:text-gray-800">Phone No</a>
              </li>
              <li>
                <a className="text-gray-600 hover:text-gray-800">E-mail</a>
              </li>
              <li>
      ...
      <div className="bg-gray-200">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-gray-500 text-sm text-center sm:text-left">© 2025 Rajasthan Auction —
            <a href="" className="text-gray-600 ml-1" target="_blank" rel="noopener noreferrer">@Yaman</a>
          </p>
          <span className="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-500 text-sm">Online Auction</span>
        </div>
      </div>
    </footer>
    <a href="https://github.com/yamanrag" className="rounded-full w-12 h-12 bg-gray-100 fixed bottom-0 right-0 flex items-center justify-center text-gray-800 mr-8 mb-8 shadow-sm border-gray-300 border" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
